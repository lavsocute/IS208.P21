...
public final class NhaCungCap extends JPanel implements ActionListener, ItemListener {
    ...
    private void initComponent() {
        ...
        tableNhaCungCap.setShowGrid(false);
        tableNhaCungCap.setIntercellSpacing(new Dimension(0, 0));
        tableNhaCungCap.setRowHeight(35);
        tableNhaCungCap.getTableHeader().setFont(new Font(FlatRobotoFont.FAMILY, Font.BOLD, 14));
        tableNhaCungCap.getTableHeader().setBackground(PrimaryColor);
