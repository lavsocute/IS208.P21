...
public final class PhieuNhap extends JPanel implements ActionListener, KeyListener, PropertyChangeListener, ItemListener {
    ...
    private void initComponent() {
        ...
        tablePhieuNhap.setRowHeight(35);
        tablePhieuNhap.getTableHeader().setFont(new Font(FlatRobotoFont.FAMILY, Font.BOLD, 14));
        tablePhieuNhap.getTableHeader().setBackground(PrimaryColor);
