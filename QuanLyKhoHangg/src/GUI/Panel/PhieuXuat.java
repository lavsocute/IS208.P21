...
public final class PhieuXuat extends JPanel implements ActionListener, KeyListener, PropertyChangeListener, ItemListener {
    ...
    private void initComponent() {
        ...
        tablePhieuXuat.setShowGrid(false);
        tablePhieuXuat.setIntercellSpacing(new Dimension(0, 0));
        tablePhieuXuat.setRowHeight(35);
        tablePhieuXuat.getTableHeader().setFont(new Font(FlatRobotoFont.FAMILY, Font.BOLD, 14));
        tablePhieuXuat.getTableHeader().setBackground(PrimaryColor);
        tablePhieuXuat.getTableHeader().setForeground(Color.white);
    ...
    public void loadDataTalbe(ArrayList<PhieuXuatDTO> listphieuxuat) {
        System.out.println("Đang load " + listphieuxuat.size() + " phiếu xuất");
