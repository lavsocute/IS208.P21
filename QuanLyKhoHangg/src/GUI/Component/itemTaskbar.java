...
//        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    ...
    FlatSVGIcon svgIcon = new FlatSVGIcon("./icon/" + iconName, size, size);
    lblIcon.setIcon(svgIcon);
}

public void setShowText(boolean show) {
    if (pnlContent != null) pnlContent.setVisible(show);
    if (pnlContent1 != null) pnlContent1.setVisible(show);
    if (pnlSoLuong != null) pnlSoLuong.setVisible(show);
