...
public class KhachHangBUS {
    ...
    public KhachHangBUS() {
        try {
            ...
            if (listKhachHang == null) {
                ...
                System.out.println("Danh sách khách hàng là null");
            }
            System.out.println("Số lượng khách hàng: " + listKhachHang.size());
        } catch (Exception e) {
            System.err.println("Lỗi khi khởi tạo KhachHangBUS: " + e.getMessage());
            e.printStackTrace();
            listKhachHang = new ArrayList<>();
        }
    }
    ...
    if (check) {
        // Làm mới toàn bộ danh sách từ database
